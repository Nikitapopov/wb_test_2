...
func main() {
	...
	// Обработка данных на основании переданной в конструкторе стратегии сортировки пузырьком
	handler.handle()

	// Создание переменной стратегии сортировки объединением
	mergeSortingStrategy := &mergeSortingStrategy{}

	// Установка стратегии сортировки объединением
	handler.setSortStrategy(mergeSortingStrategy)

	// Обработка данных на основании переданной в сеттере стратегии сортировки объединением
	handler.handle()

	// Создание переменной стратегии быстрой сортировки
	quickSortingStrategy := &quickSortingStrategy{}

	// Установка стратегии быстрой сортировки
	handler.setSortStrategy(quickSortingStrategy)

	// Обработка данных на основании переданной в сеттере стратегии быстрой сортировки
	handler.handle()
}
